 ...
 * @author Gabriel
 */
public class VentanaDjakstra extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VentanaDjakstra.class.getName());
